      ...
      if (props.status === 2) {
        ...
        return (
          <React.Fragment>
            <Chip
              ...
              id={`popovertop${props.stateValue.start}${props.stateValue.end}`}
              size="small"
              style={custom_css}
              className={`${props.status === 2 ? 'approve' : '' }`}
            />
            <UncontrolledPopover trigger="legacy" id={`popover1${props.stateValue.start}`} placement="top" target={`popovertop${props.stateValue.start}${props.stateValue.end}`}>
              <PopoverBody>
        ...
        return (
          <React.Fragment>
            ...
            />
            <UncontrolledPopover trigger="legacy" id={`popovertop1${props.stateValue.start}`} placement="top" target={`popovertop${props.stateValue.start}${props.stateValue.end}`}>
              <PopoverBody>
