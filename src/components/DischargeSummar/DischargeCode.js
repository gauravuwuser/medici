...
import SinglePagePDFViewer from './Pdf';
...
const Parent = (props) => {
    ...
    const [acsNO,setacsNO] = React.useState('');
    const [pdfPopupModal,setpdfPopupmodal] = React.useState(false);
    ...
    const getPdf = (acsNo) =>{
        let number = acsNo;
        setPdfData("acs_"+number+".pdf");
        setpdfPopupmodal(!pdfPopupModal);
    }
    const Pdfclosepopup=()=>{
        setpdfPopupmodal(!pdfPopupModal);
    }
    ...
    useEffect(() => {
        ...
        ExecuteApi('coder_sessions/' + disid, 'GET').then((resp) => {
            ...
            if (resp) {
                ...
                if (resp.session_audit) {
                    setAuditError(resp.session_audit);
                }
    ...
    function callAuditAPI() {
        let json = {}
        json = {'session_id': disid}
        ExecuteApi('session_audit/', 'POST', '', json).then((resp) => {
            setAuditError(resp)
            // let items = [
            //     'Blue',
            //     'Red',
            ...
            // let node = document.getElementById('auditerrormessage')
            // node.innerHTML = ''
            // node.appendChild(ul);
    ...
    const saveNotes = (param) => {
        ...
        if (param == 1) {
            ...
            json = {
                "note": notetextstate,
                "session_status": dischargesummarydata.session_status,
                "coder_discharge_labels": final_order
            };
        }

        let json1 = {}
        json1 = {'session_id': disid}
        ExecuteApi('session_audit/', 'POST', '', json1).then((resp)  => {
    ...
    if (Object.keys(dischargesummarydata).length !== 0 && isIcdDrg) {
        ...
        function procedureErrorMessage(tag) {
            ...
            if (error_code[0] === 'Error: Excludes1') {
                ...
                return ({
                    'data': <React.Fragment><b>AdditionalCode :</b> Additional codes must be
                ...
                return ({
                    'data': <React.Fragment><b>CodeFirst :</b> Another intervention codes must be coded first.
                ...
                return ({
                    'data': <React.Fragment><b>CodeAlso :</b> Additional codes must be coded to fully
                ...
                return ({
                    'data': <React.Fragment><b>CodeAlsoWhenPerf :</b> Additional codes must be coded to fully
            ...
            see code also when performed rules.</React.Fragment>, 'errorCode': 6
                ...
                return ({
                    'data': <React.Fragment><b>AdditionalCode :</b> Additional interventions may need to be coded. Click <span data-index="3" onClick={openDropDown} className="seeLinkErrorWarning">here</span>  to see Additional
                Code rules.</React.Fragment>, 'errorCode': 5
                });
            }
            else if (error_code[0] === 'Warning: CodeFirst') {
                return ({
                    'data': <React.Fragment><b>CodeFirst :</b>
            ...
            see Code first rules.</React.Fragment>, 'errorCode': 4
                ...
                return ({
                    'data': <React.Fragment><b>CodeAlsoWhenPerf :</b> Additional interventions, if performed, must be
        ...
        function getErrorMessage(tag) {
            ...
            if (error_code[0] === 'Error: Excludes1') {
                ...
                return ({
                    'data': <React.Fragment><b>CodeFirst :</b> Underlying etiology must be coded first.
                Click <span data-index="2" onClick={openDropDown} className="seeLinkErrorWarning">here</span> see Code first rules.</React.Fragment>, 'errorCode': 4
                });
            }
            else if (error_code[0] === 'Error: CodeAlso') {
                ...
                return ({
                    'data': <React.Fragment><b>AdditionalCode :</b> Additional codes may be required. Click <span data-index="3" onClick={openDropDown} className="seeLinkErrorWarning">here</span>  to see Additional
                Code rules.</React.Fragment>, 'errorCode': 5
                });
            }
            else if (error_code[0] === 'Warning: CodeFirst') {
                return ({
                    'data': <React.Fragment><b>CodeFirst :</b> Underlying etiology, if applicable, must be
                ...
                return ({
                    'data': <React.Fragment><b>CodeAlso :</b> Additional codes, if applicable, must be
        ...
        return (
            ...
            <React.Fragment>
                <SinglePagePDFViewer pdf={pdfData} popupModal={pdfPopupModal} Pdfclosepopup={Pdfclosepopup}/>
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-5">
                                    ...
                                    <div className="row mt-2">
                                        ...
                                        <div className="col-sm-12"><h4>NA</h4></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="row">
                    <div className="col-sm-12">
                        <div className="data_block3 mt-4">
                            <span className="pl-2">AUDITS</span>
                                <div className="col-sm-3">
                                    <p>{auditError.created_at && <b>Audit Time: </b>} 
                                    {auditError.created_at && new Date(auditError.created_at).toLocaleString()}
                                    {auditError.error === false && <p>No Errors Detected</p>}
                                    </p>
                                    <ol>
                                    {auditError.audit_errors && auditError.audit_errors.map((item, index) => {
                                        let error_type = "ACS Error";
                                        if (item.error_type === 3) {
                                            error_type = "Coding Anamoly";
                                        }
                                        else if (item.error_type === 4){
                                            error_type = "AR-DRG Suggestion"
                                        }
                                        let error_id = "";
                                        if (error_type === "ACS Error") {
                                            error_id = <li><span onClick={() => getPdf(item.error_id)} style={{color:'#ff8f8a',fontSize:'1.0rem',cursor:'pointer'}}>ACS : { item.error_id } </span></li>;
                                        }
                                        return (
                                        <li> {error_type}
                                        <ul>
                                            {error_id}
                                            <li>{item.error_message}</li>
                                        </ul>
                                        </li>
                                        );
                                    })}
                ...
                <div className="row">
                    ...
                    <div className="col-sm-12 mt-4 text-right">
                        ...
                        <Button onClick={handlePause} className="mr-2">Pause</Button>
                        <Button onClick={callAuditAPI} className="mr-2">Audit</Button>
                ...
                <Modal show={pause} onHide={handlePauseClose}>
                    <Modal.Header closeButton>
                    </Modal.Header>
                    <Modal.Body>
                        <Modal.Title> Do you want to pause coding this discharge? </Modal.Title>
                    </Modal.Body>
                    <Modal.Footer>
                        <Button variant="secondary" onClick={handlePauseClose}>
                            Close
                        </Button>
                        <Button className="btn-success" variant="primary" onClick={() => saveNotes(2)}>
                            Pause
                        </Button>
                    </Modal.Footer>
                </Modal>
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-5">
                                <div className="card">
                                    ...
                                    <div className="card-body" style={{ 'maxheight': '375px', 'height': '375px', 'padding': '1.5em 0em 1.5em 1.5em' }}>
                        ...
                        <Row>
                            ...
                            <Col md={5}>
                                <Card>
                                    ...
                                    <CardBody style={{ 'height': '375px', 'padding': '1.5em 0em 1.5em 1.5em' }}>
                                        <SimpleBar style={{ maxHeight: 350 }}>
...
class DischargeCode extends Component {
    render() {
        return (
            <div>
