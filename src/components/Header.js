                  ...
                  <li className="notification-list">
                    <Dropdown>
                      <DropdownToggle
                         ...
                         >
                          <i onClick={()=> window.open("https://stage-bi.medici.greenlakemedical.ai", "_blank")} className="dripicons-crosshair noti-icon"></i>
                      </DropdownToggle>
                  </Dropdown>
                  </li>
                ...
                <div class="container-fluid">
                        <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                            <div class="collapse navbar-collapse" id="topnav-menu-content">
                                <ul class="navbar-nav">
                                    <li class="nav-item" data-intro="Dashboard" data-position="right">
